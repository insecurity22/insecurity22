...
- 팀과의 협업에서 맡은 역할을 책임감 있게 수행하며, 일정과 품질을 고려한 개발로 팀의 작업 흐름을 안정적으로 유지했습니다.

#### **맥락을 이해하고 단계적으로 문제를 개선합니다**

- 익숙하지 않은 기술이나 도메인에서도 전체 맥락을 먼저 이해한 뒤, 필요한 부분부터 학습하고 적용하며 문제를 해결했습니다.
